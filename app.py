...
with col1:
    ...
    if ticker_choice == "その他（手入力）":
        ticker_symbol = st.text_input("銘柄コードを入力:", value="MSFT").strip().upper()
    else:
        ticker_symbol = ticker_choice.split(" ")[0] # "KO (コカ・コーラ)" から "KO" だけを抽出
