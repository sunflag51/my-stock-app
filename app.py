    ...
    if not ticker_symbol:
        ...
        with st.spinner(f"データを取得・分析中..."):
            ...
            if df.empty or len(df) < 80:
                ...
                # 💡 企業名が取得できている場合は「トヨタ【7203.T】」のように表示
                if company_name:
                ...
                # 💡 グラフのタイトルにも企業名を入れるとカッコいいので追加しました
