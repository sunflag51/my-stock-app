...
# ============================================================
DATA_DIR = "data"
DATA_FILE_RAW = os.path.join(DATA_DIR, "sp500_raw_data.csv")
DATA_FILE_JP = os.path.join(DATA_DIR, "sp500_japanese_spreadsheet.csv")
